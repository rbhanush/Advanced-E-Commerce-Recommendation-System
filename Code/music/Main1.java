...
//									  cleanText(s.getText()));
					...
					{
						String recorsdClear = "delete from musictwitsanalysis where tweet='"+cleanText(s.getText())+"'";
						...
						ArrayList<String> result = a.analyzer(comment1);
							...
							{
								query = "insert into musictwitsanalysis values('"+SEARCH_TERM+"','"+ result.get(2) +"','" + cleanText(s.getText()) + "','" + s.getCreatedAt().toString() + "','" + s.getUser().getScreenName()+ "','0','"+ result.get(1) + "')";
							}
							else
							{
								...
								if(getre.equals("0"))
								{
									query = "insert into musictwitsanalysis values('"+SEARCH_TERM+"','normal','" + cleanText(s.getText()) + "','" + s.getCreatedAt().toString() + "','" + s.getUser().getScreenName()+ "','"+ result.get(1) + "','0')";
								}
								else
								{
									query = "insert into musictwitsanalysis values('"+SEARCH_TERM+"','"+ result.get(2) +"','" + cleanText(s.getText()) + "','" + s.getCreatedAt().toString() + "','" + s.getUser().getScreenName()+ "','"+ result.get(1) + "','0')";
								}
							}
							db.getUpdate(query);

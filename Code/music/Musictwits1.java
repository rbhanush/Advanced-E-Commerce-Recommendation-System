 ...
 */
@WebServlet("/Musictwits1")
public class Musictwits1 extends HttpServlet {
	...
	try {
			while(rs.next()){
				...
				TweetManager1 td=new TweetManager1();
				tweetList=td.getTweets(twits);
				System.out.println(tweetList);
				
				if(!(tweetList.equals("")))
				{
					String recorsdClear = "delete from musictwitsrate where pid='"+twits+"'";
					db.getUpdate(recorsdClear);
				}
				String query1 = "select * from musictwitsanalysis Where pid='"+twits+"'";
				...
				if(totalsub > 0){
					...
					String sql = "Insert into musictwitsrate value('"+pid+"','"+pper+"','"+nper+"')";

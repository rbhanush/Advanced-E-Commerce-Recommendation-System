...
//	}
    ...
    public static ArrayList<String> getTweets(String topic) {
    	Main1.main(topic);
    	Twitter twitter =Main1.getTwitter();// new TwitterFactory().getInstance();
        ArrayList<String> tweetList = new ArrayList<String>();
        try {
...
//            System.out.println("query "+query);
			...
			q.setCount(Main1.TWEETS_PER_QUERY);				// How many tweets, max, to retrieve

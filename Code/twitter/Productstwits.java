 ...
 */
@WebServlet("/Productstwits")
public class Productstwits extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Productstwits() {
        super();
	...
	try {
			while(rs.next()){
				...
				if(!(tweetList.equals("")))
				{
					String recorsdClear = "delete from twitsrate where pid='"+twits+"'";
					db.getUpdate(recorsdClear);
				}
				String query1 = "select * from twitsanalysis Where pid='"+twits+"'";
				...
				System.out.println(nper);
					String sql = "Insert into twitsrate value('"+twits+"','"+pper+"','"+nper+"')";
